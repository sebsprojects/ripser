...
ripser_hrep_cohom_inverse_implicit_fixed: ripser_hrep_cohom_inverse_implicit_fixed.cpp
	c++ -std=c++11 -Wall ripser_hrep_cohom_inverse_implicit_fixed.cpp -o ripser_hrep_cohom_inverse_implicit_fixed -g
...
ripser_hrep_cohominv_o3:
	c++ -std=c++11 -Wall ripser_hrep_cohom_inverse_implicit_fixed.cpp -o ripser_hrep_cohominv_o3 -O3
...
clean:
	rm -f ripser_hrep_hom_ref ripser_hrep_hom ripser_hrep_hom_clearing ripser_hrep_cohom_hom ripser_hrep_cohom_inverse ripser_hrep_cohom_inverse_clearing ripser_hrep_cohom_inverse_forwardsubs ripser_hrep_cohom_inverse_implicit ripser_hrep_cohominv_o3 ripser_hrep_cohomhom_o3 ripser_rel_cohom ripser_rel_cohom_o3 ripser_rel_rep ripser_rel_rep_o3 ripser_hom ripser_cohom ripser_hrep_cohom_inverse_implicit_fixed
